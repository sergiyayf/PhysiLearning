...
if __name__ == '__main__':
    ...
    position = []
    is_at_front = []
    evaluation_df = pd.read_hdf('/home/saif/Projects/figuresrlpaper/data/Evaluations/2002_pc_evals_of_slvs/run_1.h5', key='run_3')
    end_t = 360
    for t in range(0, end_t):
        time = 720*t

        df = read_data(f'/home/saif/Projects/PhysiLearning/data/GRAPE_important_data/pcdl_pc_eval_of_slv_agent_for_fig5_ratchet.h5', 5, time)
    ...
    np.save('../../../figuresrlpaper/data/Figure5_ratchet.npy', position)
