...
if __name__ == '__main__':
    ...
    df = pd.read_pickle('./data/for_velocity_plotting_50_nc_runs_df.pkl')
    # Define grid size
    grid_size = 10
    ...
    # equal aspect ratio
    ax.axis('equal')
    fig.savefig('/home/saif/Projects/PhysiLearning/scripts/figures/plots/Figure_3_e_velocity.pdf', transparent = True)