...
def figure_setup(fig, ax, save_figure = False):
    ...
    if save_figure:
        fig.savefig(r'scripts/figures/plots/Figure_1_heterogeneity_new.pdf', transparent = True)
...
def plot(fig, ax):
    ...
    LV_files_list = [f'Evaluations/1402_lvs_evals/LvEnvEval__20250206_lv_1_{i}.h5' for
                     i in range(1, 11)]
