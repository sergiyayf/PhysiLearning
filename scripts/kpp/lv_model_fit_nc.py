...
def run_simulation(initial_guess=[1,2,3], initial_condition=[0.99,0.01], iterations=6):
    ...
    evaluation.env.env.growth_rate[0] = growth_rate_sus
...
def minimization_function(initial_guess):
    ...
    experiment_replicas = [f'{base}/Plate_1/Results/Results_G418_a2a4_D{i}_NT-D{i}.txt' for i in range(1,7)] + \
                          [f'{base}/Plate_3/Results/Results_G418_a2a4_A{i}_NT-A{i}.txt' for i in range(1,7)] + \
                          [f'{base}/Plate_4/Results/Results_G418_a2a4_C{i}_NT-C{i}.txt' for i in range(1,7)] + \
                          [f'{base}/Plate_5/Results/Results_G418_a2a4_B{i}_NT-B{i}.txt' for i in range(1,7)]
