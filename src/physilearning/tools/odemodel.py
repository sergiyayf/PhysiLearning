...
class ODEModel:
    ...
    def LV(self, t, X, theta):
        ...
        # equations
        dx_dt = s*(prm['r_s']*(1-(s+r*prm['c_r'])/prm['K'])-prm['delta_s']*prm['r_s']-prm['Delta_s']*self.treatment)
        dy_dt = r*(prm['r_r']*(1-(r+s*prm['c_s'])/prm['K'])-prm['delta_r']*prm['r_r']-prm['Delta_r']*self.treatment)
